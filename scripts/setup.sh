...
echo "  2. Sync large data files from your local machine (run this locally, not here):"
echo "       bash scripts/sync-data.sh"
echo "  3. Run a first deploy manually:"
echo "       bash $DEPLOY_SCRIPT"
echo "  4. Subsequent deploys happen automatically within 1 minute of a git push."
echo ""
echo "Logs:"
